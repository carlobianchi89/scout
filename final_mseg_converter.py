...
def walk(cpl_data, cost_convert, perf_convert, years, json_db, key_list=[]):
    ...
    for key, item in json_db.items():
        ...
        if isinstance(item, dict):
            walk(cpl_data, cost_convert, perf_convert, years, item,
                 key_list + [key])
        ...
        # and obtain the data to update the dict
            ...
            if key_list[-1] == 'demand':
                ...
                data_dict = env_cpl_data_handler(
                    cpl_data, cost_convert, perf_convert, years, leaf_node_keys)
